...
```
supabase/migrations/
  0021_autoevaluacion_partido.sql     # tabla + RLS
lib/autoevaluacion/
...
**Files:**
- Create: `supabase/migrations/0021_autoevaluacion_partido.sql`
...
- [ ] **Step 1: Crear `supabase/migrations/0021_autoevaluacion_partido.sql`**
...
```bash
git add supabase/migrations/0021_autoevaluacion_partido.sql
